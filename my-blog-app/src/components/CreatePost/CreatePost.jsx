    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
          ...
          <button
            type="button"
            className="bg-red-500 hover:bg-red-700 text-white font-semibold w-[150px] px-2 py-2 rounded-md h-[44px] flex items-center justify-center"
        ...
        <button
          type="submit"
          className="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-md shadow-md transition duration-200"
        >
          Publish
        </button>
