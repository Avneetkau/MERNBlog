...
const handleSubmit = async (e) =>{
  ...
  return (
    <div className = "p-3 max-w-3xl mx-auto min-h-screen">
      <h1 className="text-center text-3xl my-7 font-semibold font-serif">Create a Post</h1>
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 sm:flex-row justify-between">
            <input
             ...
             placeholder ="Title" 
             id="title" 
             className="border-2 border-gray-400 w-full rounded p-2 flex-1 font-serif" 
  ...
  <button
    type="button"
    className="bg-red-500 hover:bg-red-700 text-white font-semibold w-[150px] px-2 py-2 rounded-md h-[44px] flex items-center"
...
{ formData.image && (
  ...
  className="w-full h-72 object-cover"/>
      ...
      <button type="submit" className="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-md shadow-md transition duration-200">
      Publish
      </button>
