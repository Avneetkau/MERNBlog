       ...
       <div>
        ...
        <thead className="bg-gray-400">
          ...
          {comments.map((comment) =>(
            ...
            <td className="py-3 px-6">{new Date(comment.updatedAt).toLocaleDateString()}</td>
              ...
              setCommentIdToDelete(comment._id)}} className="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 cursor-pointer">Delete</button>
                  </td>
        ...
        {showMore && (
                        <div className="flex justify-center mt-4 ">
                            <button onClick= { handleShowMore }className=" w-full px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700">
                                Show More
                            </button>
                        </div>
                    )}
